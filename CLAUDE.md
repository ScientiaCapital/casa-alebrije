...
Task tool -> subagent_type: "observer-lite"
  prompt: "Run quality checks on the casa-alebrije codebase. Focus on [relevant area]."

# For STANDARD/FULL scope:
Task tool -> subagent_type: "observer-full"
  prompt: "Run full drift detection on casa-alebrije. The current task is: [describe task]."
```
...
**START DAY:** Start day — project is casa-alebrije. Path: ~/Desktop/tk_projects/casa-alebrije
**FEATURE BUILD:** Feature build — [FEATURE_NAME]
**END DAY:** End day — project is casa-alebrije
